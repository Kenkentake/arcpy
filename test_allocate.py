...
def test_prefers_current_stock_batches_to_shipments():
    ...
    shipment_batch = Batch("shipment-batch", "RETRO-CLOCK", 100, eta=tommorrow)
...
def test_prefers_earliest_batch():
    ...
    medium = Batch("normal-batch", "MINIMALIST-SPOON", 100, eta=tommorrow)
...
def test_returns_allocated_batch_ref():
    ...
    shipment_batch = Batch("shipment-batch", "HIGHBROW-POSTER", 100, eta=tommorrow)
...
def test_raises_out_of_stock_exception_if_cannot_allocate():
    ...
    with pytest.raises(OutOfStock, match="SMALL-FORK"):
        allocate(OrderLine("other-oref", "SMALL-FORK", 1), [batch])